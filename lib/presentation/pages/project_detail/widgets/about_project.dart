      ...
      child: Column(
        ...
        children: [
          ...
          widget.projectData.isPublic || widget.projectData.isLive
              ? SpaceH30()
              : Empty(),
          widget.projectData.isOnPlayStore || widget.projectData.isOnAppleStore
              ? Row(children: [
                  InkWell(
                    onTap: () {
                  ...
                  widget.projectData.isOnAppleStore == true
                      ? InkWell(
                          onTap: () {
                            Functions.launchUrl(
                                widget.projectData.appleStoreUrl);
                          },
                          child: AnimatedPositionedWidget(
                            controller: CurvedAnimation(
                              parent: widget.projectDataController,
