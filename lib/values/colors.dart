...
class AppColors {
  ...
  static const Color ONEDICE = Color(0xFFF6C350);
  static const Color ONEDICENavTitle = AppColors.black;
  static const Color ONEDICESelectedNavTitle = Color(0xFFF6C350);
